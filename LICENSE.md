...
This End User License Agreement (the "Agreement") is a binding legal agreement between you and Shaun Inman (the "Author"). By installing or using Fever (the "Software"), you agree to be bound by the terms of this Agreement. If you do not agree to the Agreement, do not download, install, or use the Software. Installation or use of the Software signifies that you have read, understood, and agreed to be bound by the Agreement.

Revised on: 4 February, 2017
