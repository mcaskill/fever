...
- added ?empty query command to delete all groups and unsubscribe from all feeds- tweaked tag splitting regex in OMDOMDOM to better handle feeds with unencoded >s
